...
import { VOYAGE_OBJECT_INITIAL_STATE, VOYAGE_OBJECT_REDUCER } from "./voyage-list/voyage-list.types"
...
export const reducers = combineReducers({
    ...
    [ VOYAGE_OBJECT_REDUCER ]: objectReducer({
        reducerName: VOYAGE_OBJECT_REDUCER,
        initialState: VOYAGE_OBJECT_INITIAL_STATE
    }),
})